  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8 mt-6 transition hover:shadow-2xl">
      ...
      <div className="flex flex-col sm:flex-row justify-end gap-2 mb-4">
        <button
          onClick={() => (userPlan === 'Free' ? navigate('/subscribe') : setShowRequestModal(true))}
        ...
        >
          <FaPenFancy className="sm:mr-2" /> <span className="hidden sm:inline">{userPlan === 'Free' ? 'Upgrade to Request' : 'Request New Session'}</span>
        </button>
        <button
              ...
              <p className="text-sm text-neutral-dark mb-2">{app.programName}</p>
                ...
                userPlan === 'Free' ? (
                  <button
                    ...
                    className="mt-2 w-full bg-yellow-500 text-white font-semibold py-2 px-3 sm:px-4 rounded-full hover:bg-yellow-600 transition text-sm sm:text-base"
                  >
                    Upgrade to Request
                  </button>
                ) : (
