...
export type ModalMap = {
  ...
  // --- APPLICATION TRACKER ---
  addApplicationModal: {
    type: "addApplicationModal";
    props: AddApplicationModalPayload;
  };
  editApplicationModal: {
    type: "editApplicationModal";
    props: ApplicationBaseProps;
  };
  applicationDetailModal: {
    type: "applicationDetailModal";
    props: ApplicationBaseProps;
  };
  ...
  financialSupportForm: {
    type: "financialSupportForm";
    props: BaseModalProps & {
      applications?: Application[];
      userGroups?: Group[];
    };
  };
  financialSupportHistory: {
    type: "financialSupportHistory";
    props: BaseModalProps;
  };
  projectsModal: { type: "projectsModal"; props: BaseModalProps };
  financialSupportModal: {
    type: "financialSupportModal";
    props: BaseModalProps;
  };
  ...
  mentorConnectionModal: {
    type: "mentorConnectionModal";
    props: BaseModalProps;
  };
...
export const ModalProvider = ({
  ...
  const openModal = <T extends ModalName>(
    name: T,
    props: ModalPayload<T> = {} as ModalPayload<T>,
  ) => {
  ...
  const selectedApplication = (modalState.props as ApplicationBaseProps)
    ?.application;
  ...
  const handleViewDashboardSections = () => {
    console.log(
      "Scrolling to dashboard sections is a Dashboard-specific action.",
    );
    closeModal();
  };
  ...
  const renderModal = () => {
    ...
    switch (modalState.name) {
      ...
      case "trackerModal": {
        ...
        } = modalProps as TrackerModalPayload;
        ...
        return currentUserUid ? (
          <Modal {...baseProps} title="SOP & CV Live Writing" size="lg">
            <DocumentReviewServices
              ...
              onRequestSOPWriting={
                handleRequestSOPWriting as (applicationId: string) => void
              }
        ...
        return (
          <Modal {...baseProps} title="AI Prediction Results" size="md">
            <div className="p-4 text-gray-700">
              AI Prediction component goes here.
            </div>
          </Modal>
        );
      ...
      case "confirmationModal": {
        ...
        const {
          ...
          confirmButtonText,
          cancelButtonText,
        } = modalProps as ConfirmationModalProps;
        return (
          <ConfirmationModal
            isOpen={true}
